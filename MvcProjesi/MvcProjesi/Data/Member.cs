...
namespace MvcProjesi.Data
{
    public class Member
    {
        ...
        [StringLength(50, MinimumLength = 3, ErrorMessage = "Kullanıcı adınızı 3-50 karakter arasında girebilirsiniz.")]
       ...
       /* [Required(ErrorMessage = "Lütfen e-posta adresinizi giriniz.")]
        ...
        //Girilen metnin, geçerli bir e-posta adresi formatında girilmesini sağlıyoruz. 
        //DataType tipleri, Microsoft tarafından Framework'e eklenen hazır tiplerdir.
        [DataType(DataType.Password, ErrorMessage = "Lütfen e-posta adresinizi geçerli bir formatta giriniz.")]
